...
def train():
    inicio = time.time()
    # Pegando as imagens
    red_lights = [img for img in glob.glob("./5_tensorflow_traffic_light_images/red/*.jpg")]
    yellow_lights = [img for img in glob.glob("./5_tensorflow_traffic_light_images/yellow/*.jpg")]
    green_lights = [img for img in glob.glob("./5_tensorflow_traffic_light_images/green/*.jpg")]
